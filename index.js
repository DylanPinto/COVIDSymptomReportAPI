    ...
    res.send("<html>"+
                ...
                "<body style=\"font-family: Arial;margin: 0;\">" +
                    "<div style=\"height:25%;text-align:center;position:absolute;left:30%;top:20%\" class=\"content\">" +
                        ...
                        //"<p><a href=\"https://covidsymptomreportapp.azurewebsites.net/covidreportapi\"><img src=\"https://cavedweller92.files.wordpress.com/2019/07/swagger-logo-horizontal.png\" height=\"100\" class=\"image\"></a>" +
                        "<p><a href=\"https://covidsymptomreportapp.herokuapp.com/covidreportapi\"><img src=\"https://cavedweller92.files.wordpress.com/2019/07/swagger-logo-horizontal.png\" height=\"100\" class=\"image\"></a>" +
                        "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp" + 
                        //"<a href=\"https://covidsymptomreportapp.azurewebsites.net/graphql\"><img src=\"https://www.pngitem.com/pimgs/m/385-3850895_graphql-logo-svg-hd-png-download.png\" height=\"100\" class=\"image\"></a></p>" +
                        "<a href=\"https://covidsymptomreportapp.herokuapp.com/graphql\"><img src=\"https://www.pngitem.com/pimgs/m/385-3850895_graphql-logo-svg-hd-png-download.png\" height=\"100\" class=\"image\"></a></p>" +
...
const uri = `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@cluster0.bxf4m.mongodb.net/${process.env.MONGO_DB}?retryWrites=true&w=majority`
